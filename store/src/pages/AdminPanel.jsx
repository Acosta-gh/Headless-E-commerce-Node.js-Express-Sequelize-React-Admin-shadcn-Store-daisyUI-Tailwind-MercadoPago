  ...
  const handleDeleteCategoria = async (id) => {
    if (window.confirm("¿Eliminar esta categoría?")) {
      try {
        ...
        alert(
          "Error al eliminar la categoría. Puede que tenga items asociados o no tengas permisos."
        );
      }
      fetchCategorias();
      fetchItems();
            ...
            >
              ...
              <div className="md:col-span-2 flex flex-wrap gap-3 mt-4">
                <button
                  type="submit"
                  disabled={uploading}
                  className={`bg-gray-900 text-white px-6 py-3 rounded-full hover:bg-gray-800 transition flex items-center gap-2 ${
